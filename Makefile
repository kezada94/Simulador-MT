#############################################################################
# Makefile for building: Simulador-MT
# Generated by qmake (3.1) (Qt 5.8.0)
# Project:  Simulador-MT.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Simulador-MT.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Simulador-MT1.0.0
DISTDIR = /home/kezada/git/Simulador-MT/.tmp/Simulador-MT1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Simulador-MT.pro ui_layout.h main.cpp
QMAKE_TARGET  = Simulador-MT
DESTDIR       = 
TARGET        = Simulador-MT
...
$(TARGET): ui_layout.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Simulador-MT.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Simulador-MT.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents ui_layout.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp $(DISTDIR)/
	$(COPY_FILE) --parents layout.ui $(DISTDIR)/
...
compiler_uic_make_all: ui_layout.h
compiler_uic_clean:
	-$(DEL_FILE) ui_layout.h
ui_layout.h: layout.ui \
		/usr/bin/uic
	/usr/bin/uic layout.ui -o ui_layout.h
